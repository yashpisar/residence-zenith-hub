...
import { activityFeed, categorySplit, complaints, complaintTrend } from "@/lib/mock-data";
import { chartTheme, tooltipStyle } from "@/lib/chart-theme";

export const Route = createFileRoute("/_authenticated/resident/dashboard")({
...
function ResidentDashboard() {
  ...
  const stats = [
    { label: "Open complaints", value: 3, change: -25, icon: ClipboardList, tone: "info" },
    { label: "Maintenance due (₹)", value: 4800, change: 0, icon: Wallet, tone: "amber" },
    { label: "Visitors this month", value: 27, change: 12, icon: DoorOpen, tone: "primary" },
    { label: "Pending approvals", value: 2, change: 8, icon: ShieldCheck, tone: "destructive" },
  ];
        ...
        {[
          {
            ...
            title: "Maintenance",
            stat: "₹4,800 due",
            desc: "July billing cycle is pending.",
            to: "/maintenance",
          },
          {
            icon: DoorOpen,
            title: "Gate security",
            stat: "27 entries",
            desc: "You have approved 27 visitors this month.",
            to: "/visitor-approval",
          },
        ].map((c) => (
