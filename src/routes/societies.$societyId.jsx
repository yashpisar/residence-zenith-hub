      ...
      case "Suspended":
        return (
          <Badge variant="destructive">
            <ShieldAlert className="size-3 mr-1" /> Suspended
          </Badge>
        );
    }
  };
      ...
      <div className="relative h-64 md:h-80 w-full">
        ...
        <div className="absolute top-4 left-4 z-10">
          <Button
            ...
            onClick={() => navigate({ to: "/select-society" })}
          >
            Back to Selection
          </Button>
        </div>
          ...
          <div className="flex items-end gap-6">
            ...
            <div className="pb-2">
              ...
              <p className="text-muted-foreground flex items-center gap-2">
                <MapPin className="size-4" /> {society.address}, {society.city}, {society.state} -{" "}
                {society.pinCode}
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-muted/50 p-4 rounded-xl border border-border">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {society.wings.map((w) => w.name).join(", ")}
                  </p>
                </div>
                <div className="bg-muted/50 p-4 rounded-xl border border-border">
                ...
                <div className="col-span-2 bg-blue-500/10 p-4 rounded-xl border border-blue-500/20">
                  ...
                  <p className="text-xs text-blue-600/70 dark:text-blue-400/70 font-semibold uppercase">
                    Total Residents
                  </p>
                </div>
              </div>
                ...
                {[
                  {
                    ...
                    val: Math.floor(society.totalFlats * 0.85),
                    color: "text-green-500",
                  },
                  {
                    label: "Vacant Flats",
                    val: Math.ceil(society.totalFlats * 0.15),
                  ...
                  <div
                    key={i}
                    className="text-center p-4 bg-muted/30 rounded-xl border border-border"
                  >
