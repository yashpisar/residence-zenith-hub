                ...
                {isBlacklisted && (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium">
                      This visitor has been blacklisted. Secretary override is required for entry.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, expectedExitTime: e.target.value })
                      }
                      className="input-field pl-9 w-full"
                    />
                  </div>
              ...
              <AnimatePresence mode="wait">
                ...
                {status === "approved" && (
                  ...
                  >
                    ...
                    <h4 className="text-lg font-bold text-success-foreground mb-1">
                      Entry Approved
                    </h4>
                    <p className="text-sm text-muted-foreground mb-4">
                      Pass generated successfully. Hand over the pass to the visitor.
                    </p>
                ...
                {status === "rejected" && (
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground">
                      The resident rejected this visitor request.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
