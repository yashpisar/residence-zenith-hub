...
export const Route = createFileRoute("/_authenticated/notices")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Society announcements, circulars and emergency broadcasts." },
      { property: "og:title", content: "Notices — Havenly Estates" },
      { property: "og:description", content: "Society announcements, circulars and emergency broadcasts." },
    ],
  }),
  component: Page,
});
