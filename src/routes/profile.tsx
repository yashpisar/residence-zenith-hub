...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your flat, family members, vehicles and contact preferences." },
      { property: "og:title", content: "Profile — Havenly Estates" },
      { property: "og:description", content: "Your flat, family members, vehicles and contact preferences." },
    ],
  }),
  component: Page,
});
