...
export const Route = createFileRoute("/visitor-approval")({
  head: () => ({
    meta: [
      { title: "Visitor Approval — Havenly Estates" },
      { name: "description", content: "Approve or deny gate requests in realtime from your device." },
      { property: "og:title", content: "Visitor Approval — Havenly Estates" },
      { property: "og:description", content: "Approve or deny gate requests in realtime from your device." },
    ],
  }),
  component: Page,
});
