...
export const Route = createFileRoute("/_authenticated/staff")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Housekeeping, security and technicians with shifts and attendance." },
      { property: "og:title", content: "Staff — Havenly Estates" },
      { property: "og:description", content: "Housekeeping, security and technicians with shifts and attendance." },
    ],
  }),
  component: Page,
});
