...
export const Route = createFileRoute("/_authenticated/emergency")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trigger fire, medical or security alerts to the whole society." },
      { property: "og:title", content: "Emergency — Havenly Estates" },
      { property: "og:description", content: "Trigger fire, medical or security alerts to the whole society." },
    ],
  }),
  component: Page,
});
