...
export function CameraCapture({ onCapture, label = "Visitor Photo" }: CameraCaptureProps) {
        ...
        {image ? (
          ...
          <div className="relative w-full h-[240px] bg-black">
            ...
            <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4 px-4">
              <Button size="icon" variant="secondary" onClick={() => setMirrored(!mirrored)} className="rounded-full shadow-lg">
              ...
              <Button size="icon" variant="destructive" onClick={() => setIsCameraActive(false)} className="rounded-full shadow-lg">
                <X className="size-4" />
              </Button>
            </div>
          </div>
