...
export function VisitorDetailsModal({ visitor, isOpen, onClose, onStatusChange }) {
  ...
  if (visitor.status !== "Awaiting approval") {
    mockTimeline.push({
      ...
      user: "Ananya Rao",
      role: "Resident",
      remarks: "Please leave the package at the door if I don't answer.",
    });
    mockTimeline.push({
      id: "5",
      type: "pass_generated",
  ...
  if (visitor.status === "Exited") {
    mockTimeline.push({
      id: "7",
      type: "checked_out",
      timestamp: visitor.exit || "11:00 AM",
      user: "Ramesh Guard",
      role: "Security",
    });
  }
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex gap-4 items-center">
              <div className="h-16 w-16 rounded-full bg-muted overflow-hidden border-2 border-primary/20">
                <img
                  src={`https://ui-avatars.com/api/?name=${visitor.name}&background=random`}
                  alt={visitor.name}
        ...
        <ScrollArea className="flex-1 p-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                <h4 className="text-sm font-bold uppercase tracking-wider text-muted-foreground mb-3 border-b border-border pb-1">
                  Details
                </h4>
            ...
            <div className="bg-background rounded-xl p-5 border border-border shadow-sm">
              ...
              <VisitorTimeline events={mockTimeline} />
            </div>
          </div>
        </ScrollArea>
        ...
        {visitor.status === "Inside" && (
          <div className="p-4 bg-muted/20 border-t border-border flex justify-end">
            <Button
              ...
              variant="default"
              className="shadow-lg font-bold bg-slate-800 hover:bg-slate-700 text-white"
            >
