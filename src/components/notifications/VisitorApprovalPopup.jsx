      ...
      <DialogContent className="sm:max-w-md overflow-hidden p-0 border-0 shadow-2xl">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <DialogFooter className="flex gap-3 p-6 pt-0 sm:justify-between bg-card">
            <Button
              variant="outline"
              className="w-full sm:w-auto flex-1 h-12 text-destructive hover:text-destructive hover:bg-destructive/10 border-destructive/20"
            ...
            <Button
              variant="default"
              className="w-full sm:w-auto flex-1 h-12 bg-success hover:bg-success/90 text-white shadow-lg shadow-success/30"
