export const complaints = [
  {
    id: "CMP-2041",
    title: "Lift stuck between floors 6 and 7",
    category: "Elevator",
    flat: "B-704",
    raisedBy: "Ananya Rao",
    status: "Escalated",
  ...
  {
    id: "CMP-2028",
    title: "Unauthorised parking in slot 44",
    category: "Parking",
    flat: "A-1101",
    raisedBy: "Meera Iyer",
    status: "Resolved",
  ...
  {
    id: "CMP-2024",
    title: "Gym treadmill making loud noise",
    category: "Amenities",
    flat: "B-208",
    raisedBy: "Karan Bhatia",
    status: "Open",
    priority: "Low",
    updated: "Yesterday",
  },
  {
    id: "CMP-2019",
    title: "Intercom not connecting to gate",
    category: "Security",
    flat: "C-601",
    raisedBy: "Divya Nair",
    status: "Resolved",
  ...
  {
    id: "CMP-2015",
    title: "Swimming pool water is cloudy",
    category: "Amenities",
    flat: "D-404",
    raisedBy: "Aditya Ghosh",
    status: "In Progress",
    priority: "Medium",
    updated: "3 days ago",
  },
  {
    id: "CMP-2011",
    title: "Fire extinguisher expired on 5th floor",
    category: "Safety",
    flat: "B-509",
  ...
  {
    id: "CMP-2007",
    title: "Damaged tiles near clubhouse entry",
    category: "Civil",
    flat: "A-806",
  ...
  {
    id: "CMP-2003",
    title: "Pest control required in kitchen",
    category: "Housekeeping",
    flat: "C-207",
    raisedBy: "Fatima Khan",
    status: "Open",
    priority: "Medium",
    updated: "5 days ago",
  },
  {
    id: "CMP-1998",
    title: "Visitor parking barrier malfunction",
    category: "Security",
    flat: "D-101",
...
export const activityFeed = [
  {
    ...
    detail: "Swiggy delivery • Gate 2 • Flat B-704",
    time: "Just now",
    tone: "info",
  },
  {
    ...
    detail: "CMP-2041 elevator fault escalated to vendor",
    time: "12 min ago",
    tone: "danger",
  },
  {
    ...
    detail: "₹4,800 from Flat A-302 for July cycle",
    time: "38 min ago",
    tone: "success",
  },
  {
    ...
    detail: "Water tank cleaning scheduled for Sunday",
    time: "2 hrs ago",
    tone: "primary",
  },
  {
    ...
    detail: "Ramesh (Plumber) assigned to CMP-2039",
    time: "3 hrs ago",
    tone: "warning",
  },
];
